...
import { RestaurantPageActions } from "./products/components/restaurant-page-actions.component";
    ...
    <div className="relative flex flex-1 flex-col">
      <Breadcrumb.Root className="container-default pt-4">
        <Breadcrumb.List>
          ...
          <Breadcrumb.Item>{restaurant.name.toLowerCase()}</Breadcrumb.Item>
        </Breadcrumb.List>
      </Breadcrumb.Root>
      ...
      <RestaurantPageActions restaurant={restaurant} />
    </div>
  );
}
